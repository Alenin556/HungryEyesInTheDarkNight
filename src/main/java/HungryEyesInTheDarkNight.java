...
public class HungryEyesInTheDarkNight {
    public static void main(String[] args) {
        ...
        System.out.println(" М : Вчера вечером из деревни я видел как там, кто-то колдует, потому как лес загорался разными красками в ночи, то зелеными , то желтыми ,иногда и фиолетовым.");
