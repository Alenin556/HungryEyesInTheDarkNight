...
public class HungryEyesInTheDarkNight {
    public static void main(String[] args) {
        ...
        System.out.println(" ");
        System.out.println("Зайдя в таверну, чтобы перевести дух и выпить, усевшись за стол и заказав выпив у хозяйки таверны, вы слышите как за соседнем столом переговаривались мужики -");
        ...
        System.out.println(" ");
        System.out.println("Завершив все необходимые приготовления и помолившись перед большой иконой, вы выходите из дома.");
        System.out.println(" ");
