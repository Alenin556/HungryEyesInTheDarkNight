...
public class MeetingWithLeshii {
    ...
    public static void meetingWithLeshii() {
        ...
        System.out.println("Пробираясь в ночи, через чащу леса вам всюду навстречу попадаются метки когтей на деревьях, порой бывает что вместе с метками под деревьями лежат чьи то останки в крови.");
