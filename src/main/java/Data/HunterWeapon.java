...
public class HunterWeapon {
    ...
    public static void chooseWeapon() {
        ...
        System.out.println("Над мечом вашего отца, висит копье вашего прадеда. Копье средней тяжести и с золотым наконечников. На это копье было насажено более 1000 вампиров.");
        System.out.println("Справа от меча отца, висит ваш меч. Меч легко лежит у вас в руке и вы справляетесь с ним с необыкновенной ловкостью, таким мечом можно пользоваться даже тогда, когда против вас могут быть десятки противников.");
        System.out.println(" ");
